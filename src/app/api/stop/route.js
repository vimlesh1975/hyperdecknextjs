...
export async function POST(req) {
  try {
    ...
    if (target === "all" || target === "deck1" || target === "1") {
      controllers.push({ id: "deck1", url: `${getBaseUrl("deck1")}/transports/0/stop` });
    }
    if (target === "all" || target === "deck2" || target === "2") {
      controllers.push({ id: "deck2", url: `${getBaseUrl("deck2")}/transports/0/stop` });
    }
    if (target === "all" || target === "deck3" || target === "3") {
      controllers.push({ id: "deck3", url: `${getBaseUrl("deck3")}/transports/0/stop` });
    }
    if (target === "all" || target === "deck4" || target === "4") {
      controllers.push({ id: "deck4", url: `${getBaseUrl("deck4")}/transports/0/stop` });
    }
